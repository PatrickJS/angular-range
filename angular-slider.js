...
(function() {
  var MODULE_NAME, RANGE_TAG, SLIDER_TAG, angularize, bindHtml, gap, halfWidth, hide, inputEvents, module, offset, offsetLeft, pixelize, rangeDirective, roundStep, show, sliderDirective, width;
            ...
            updateDOM = function() {
              ...
              bindToInputEvents = function(pointer, ref, events) {
                ...
                onMove = function(event) {
                  var bufferSize, eventX, maxLowValue, minHighValue, newOffset, newPercent, newValue, _ref2, _ref3, _ref4;
